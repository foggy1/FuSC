          ...
          <div className='footer'>
            ...
            <ul className='rrssb-buttons clearfix'>
              <li className='rrssb-facebook'>
                <a href={`https://www.facebook.com/sharer/sharer.php?u=http://fuckupsomecomics.com${(route.page.path)}`} className='popup'>
              ...
              <li className='rrssb-twitter'>
                <a href={`https://twitter.com/intent/tweet?text=Foggy wrote a thing (@AustinLanari) http://fuckupsomecomics.com${(route.page.path)}`}
                  className='popup'>
              ...
              <li className='rrssb-tumblr'>
                <a target='_blank' href={`http://tumblr.com/share/link?url=http://fuckupsomecomics.com${(route.page.path)}`}>
              ...
              <li className='rrssb-googleplus'>
                <a href={"https://plus.google.com/share?url=" + encodeURI(`http://fuckupsomecomics.com${(route.page.path)}`)} className='popup'>
                  <span className='rrssb-icon'>
              ...
              <li className='rrssb-pocket'>
                <a href={`https://getpocket.com/save?url=http://fuckupsomecomics.com${(route.page.path)}`}>
                  <span className='rrssb-icon'>
